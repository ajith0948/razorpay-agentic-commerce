...
import { QuotePanel } from "@/components/buyer/quote-panel";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">
          Review quotes received for your RFQs and accept them.
        </p>
      </div>
      ...
      <div className="relative w-full rounded-lg border p-4 [&>svg]:absolute [&>svg]:text-foreground [&>svg]:left-4 [&>svg]:top-4 [&>svg+div]:translate-y-[-3px] [&>:not(svg)]:pl-7">
        ...
        <div className="text-sm [&_p]:leading-relaxed">
          The backend does not currently provide a list endpoint for Quotes. 
          Please look up a quote by its exact ID below.
        </div>
      </div>
            ...
            <tbody>
              <tr>
                <td colSpan={7} className="px-4 py-8 text-center text-muted-foreground">
                  No Quotes to display. Use the lookup tool below.
                </td>
              </tr>
            </tbody>
          </table>
